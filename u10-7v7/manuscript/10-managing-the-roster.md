...
Fourteen is the ideal roster size for U10 7v7. Seven starters, seven substitutes, and a clean halftime swap means every player gets roughly equal minutes. It also means you have enough players to run competitive scrimmages in practice — seven versus seven — without needing to borrow from another team or play with uneven sides.

With fourteen players, your substitution math is simple. Start seven. Sub in the other seven at halftime. In the second half, make two or three adjustments based on the game situation — bring back your strongest defenders if you are protecting a lead, or your most dangerous attackers if you need a goal. Over the course of the season, the starting lineup should rotate so that every player gets roughly the same number of starts.

The fourteen-player model has a built-in redundancy for absences. If two players cannot make a game — illness, family events, conflicts — you still have twelve, which gives you five substitutes and comfortable rotation. If three or four are out, you still have ten or eleven, which is thin but workable.

## Smaller Rosters

If you have ten or eleven players, every player is getting significant minutes every game. The challenge is not playing time — it is depth. If two players are absent, you are fielding exactly seven with no substitutes — every player plays the full game. That makes conditioning and cross-training even more valuable.

With a small roster, cross-training becomes even more critical. Every player needs to be able to play at least two positions competently, because you do not have the luxury of a dedicated backup for each role. Your left back should know how to play left wing. Your point should know how to play sweeper. If your goalkeeper is absent, someone else steps in and the team keeps its shape.

If you have twelve or thirteen players, you are in decent shape. Plan your substitutions in thirds rather than halves: rotate three or four players at the twenty-minute mark and again at the forty-minute mark. This gives everyone roughly forty minutes in a sixty-minute game, which is more than adequate for development and meets most league minimum-play requirements.

If you have fifteen or sixteen players, you have a luxury problem. More depth and more competition for spots, but also more players contributing and more families invested in the team's success. The principles are the same as the fourteen-player model, but you will need to be more deliberate about tracking minutes to ensure equitable distribution.
...
**Point:** Competitive, resilient, quick off the mark. The player who wants the ball in big moments. The player who misses a shot and immediately looks for the next one instead of dropping their head.

After the first two weeks, assign primary positions. Tell each player their position and why they are there. Be specific. "Sofia, you are our left back because you are fast, you are smart, and you do not panic when someone comes at you. That is exactly what we need on the left side." When a player understands why they are at a position, they take ownership of it.

You can share the math with the team if you want. "There are almost four million ways I could pick a starting seven from this roster. The reason you are starting at left back is because of what you did at practice this week." It sounds dramatic because the number is dramatic. But it is real, and it gives every player agency: the starting lineup is not random and it is not fixed. It reflects the work.

## Specialization vs. Rotation
...
The ratio should be roughly seventy-thirty. Seventy percent of a player's game minutes at their primary position, thirty percent at their secondary position. In a ten-game season, that means seven games at the primary position and three at the secondary. This gives enough consistency to develop expertise while still providing breadth.

The exception is the goalkeeper. If you have a player who genuinely wants to be the goalkeeper and shows aptitude for it, let them specialize fully. Goalkeeper is the most position-specific role on the field, and the skills developed there — positioning, shot-stopping, distribution, communication — benefit from maximum repetition. Rotate a backup goalkeeper through the position at practice and in games where the primary keeper is absent, but do not force your best goalkeeper to play in the field just for the sake of rotation.

## Managing Minutes

Track every player's minutes in your notebook. After every game, record who played where and for how long. At the end of each month, review the totals. If one player has significantly fewer minutes than the rest, correct the imbalance in the next game.
