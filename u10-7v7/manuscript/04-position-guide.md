...
The six field positions are: left back, right back, sweeper, point, left wing, and right wing. Plus the goalkeeper. This guide is organized by role, building from the back — goalkeeper, backs, sweeper, wings, point — because the two backs share the same job and the two wings share the same job. The left and right distinction tells the player which side of the field is their home. The role tells them what to do. In the neutral 2-1-1-2 shape, the backs form the base of the defensive triangle with the sweeper at its apex. The point sits at the base of the attacking triangle, with the wing strikers reading the game and finding opportunities in the attacking third. When the shape shifts, every position shifts with it as described in chapter 3.

One note before diving in: at U10, players should experience multiple positions over the course of a season. Specialization too early limits development. That said, every player needs a primary position — the one they know best, the one they play in important moments. This chapter helps you teach each position deeply enough that a player can own it.
...
At U10, the goalkeeper position is unique because many leagues rotate goalkeepers or allow players to volunteer. Whether you have a dedicated goalkeeper or rotate players through the position, every player who steps between the posts needs to understand the basics. A goalkeeper who knows what they are doing is the difference between a close game and a blowout.

**Physical demands:** The goalkeeper needs quick reflexes and reasonable hand-eye coordination. They do not need to be the most athletic player on the team, but they need to be brave — willing to dive, willing to come out and face a shooter one-on-one, willing to get hit by the ball. Size is an advantage but not a requirement at this age. A small goalkeeper who is fearless and positioned well will stop more shots than a tall goalkeeper who flinches.

**Mental demands:** The goalkeeper needs concentration. They may go five minutes without touching the ball, then suddenly face a breakaway. They need to be ready for that moment even after minutes of inaction. They also need the thickest skin on the team. Goals will go in. Some of them will be saveable. The best goalkeepers reset immediately. A goal goes in, and five seconds later they are focused on the next play. That resilience keeps the team in every game.
...
A cross comes into the box. The goalkeeper has to decide whether to come out and catch it or stay on the line. The rule at U10 is simple: if you can get to the ball, come get it. Yell "keeper" so your defenders know to clear out. Catch the ball at the highest point you can. If you cannot get to the ball — it is too far away or too high — stay on your line and be ready for the shot or header that follows. Coming out and missing the ball is worse than staying home and making the save.

**Areas to develop:**

Standing on the goal line. The goalkeeper glues themselves to the line and waits for shots. This gives shooters the maximum target to aim at. Coach it: positioning drills every practice. The goalkeeper should be one to three yards off the line depending on where the ball is. Make this a habit.

Building communication. The goalkeeper can see the entire field — they have the best view of anyone on the pitch. Encourage them to direct the defense constantly: "Left back, watch the runner." "Shift right." "I have it." Coach it: in scrimmages, challenge the goalkeeper to say something every thirty seconds. It does not need to be perfect tactical instruction. It just needs to be something. Communication is a muscle that develops with use.

Directing saves to safety. Every save should send the ball away from the center of the goal. Coach it: teach the goalkeeper to parry to the sidelines — push the ball wide, away from the middle. If they can catch it, even better. But if they cannot hold it, send it out.
...
Because the two backs share the same primary responsibility — the center — they need to work as a unit. In a 3v2, they stack and switch. In a 2v1, whichever back is closer to the ball engages while the other covers. They need to communicate constantly: "I have the ball." "Cover center." "I am going wide." "Send it out." If the backs are silent, the defensive pairing falls apart.

When a back wins the ball, they send it out. Out means toward the sideline — a pass to their wing up the sideline, a clearance toward the touchline, even a deliberate kick out of bounds if that is the safest option. **The backs do not play the ball through the center of the defensive third.** That is where turnovers become goals. The ball goes out, toward the sideline, where the wing striker can collect it and go, or where the opponent has to chase it into the corner and deal with the touchline as an extra defender.

If an opponent has the ball out wide, the nearest back does need to recognize it. They go challenge, they pin the attacker to the corner, they force a bad cross or a turnover. But that is a secondary responsibility. The primary read is always the center first. If there is no threat wide, the backs stay pinched in. Let the opponent kick it to the open player in the corner. That player is not dangerous. A nine-year-old crossing the ball from the corner under pressure is not Roberto Carlos. Let them try. What you cannot let them do is run straight through the middle.

**Physical demands:** The backs need to be quick in short bursts — closing down attackers who threaten the center and recovering position after a challenge. Footwork matters more than top speed. A back who can shuffle laterally and stay balanced is more valuable than a fast one who lunges and gets turned.

**Mental demands:** The backs need to resist the instinct to stay wide. Most youth coaches teach backs to "hold the flank." This system does the opposite: the backs pinch in and control the center. They need to understand that leaving space on the sideline is fine — the touchline is there. Leaving space in the center is not fine — that is where goals happen. The backs also need composure when they win the ball. The instinct is to boot it forward. The correct play is to send it out toward the sideline, where it is safe.
...
The opponent plays a long ball over the top to a player out wide. The nearest back goes to challenge, pins them to the corner, and forces a bad cross or a turnover. If the cross comes in, the other back and the sweeper are already in the center to deal with it. If the attacker beats the back, the sideline is right there to limit where they can go.
...
Staying wide when the danger is central. The back holds their position on the sideline while the opponent dribbles straight through the center. Coach it: "Pinch in. The center is your responsibility. The sideline is not going anywhere."

Playing the ball through the center of the defensive third. The back wins the ball and passes it to the sweeper in the middle of the box. The pass gets intercepted and the opponent has a shot on goal. Coach it: "Send it out. Always out. To the sideline, to the wing, out of bounds if you have to. Never through the center in our end."

Diving in. The back lunges for the ball instead of staying on their feet and containing the attacker. The attacker sidesteps them and has a clear run to goal. Coach it: "Stay on your feet. Slow them down. Force them to the sideline. Help will come."

Not communicating. The two backs need to talk constantly. "I have center." "Go challenge wide." "Switching." "Send it out." The backs who communicate are the backs who hold the center.
...
The sweeper's third job is communication. They can see the whole field. If they are silent, the team is blind. The sweeper should be the loudest voice on the field after the goalkeeper, constantly directing the backs, warning of runners, and calling for the ball.
...
Getting stuck in one third. The sweeper who only defends and never pushes forward to link with the point is doing half the job. The sweeper who pushes too far forward and leaves the center exposed is equally dangerous. Coach it: the sweeper's home is the center of the field, and they range forward and back from there. In practice, use the freeze technique to check their positioning. "Where are you? Where should you be? Show me."

Not talking. If the sweeper is silent, the defense is guessing. Coach it: give the sweeper specific phrases. "Push up" when the team needs to advance the line. "Get back" when the 6-0 is needed. "Switch it" when one side is overloaded. "Runner left" or "runner right" when an opponent is making a dangerous run. Start with those and add more as the season progresses.

Trying to do everything alone. The sweeper receives the ball and tries to dribble past three players instead of using the passing lanes the formation creates. Coach it: reinforce that the sweeper is a distributor. Their job is to make the simple pass that keeps the team moving. The spectacular play will come from the wing strikers and the point. The sweeper makes the play possible by finding them.
...
**Mental demands:** The point needs a short memory. They will miss chances. They will take bad touches. They will get tackled. The best points have a short memory. Miss a shot, forget it, and immediately look for the next opportunity. That reset speed is what makes the position dangerous.
...
Cherry-picking. The point stays high even when the team is in the 6-0, hoping for a long ball over the top. This leaves the sweeper alone in the center and creates a gap in the defensive block. Coach it: the rule is simple — when we defend, the point drops all the way back. The counter-attack is more explosive from the 6-0 because the point already has forward momentum when possession changes.

Shooting from too far out. At U10, close-range shots convert at a far higher rate. The point should be looking to get close before shooting. Coach it: in practice scrimmages, set a rule that shots must be taken from inside a certain zone. This trains the point to work the ball closer before shooting.

Not combining. The point receives the ball centrally and tries to beat everyone alone instead of using the wing strikers. Coach it: reinforce that the point has two wing strikers making runs for a reason. Play them. Combine with them. The solo run will work sometimes, but the pass to the open wing works more often.
