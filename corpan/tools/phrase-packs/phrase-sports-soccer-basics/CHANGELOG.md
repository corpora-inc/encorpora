# Changelog — Soccer Basics phrase pack

`phrase-sports-soccer-basics`. 100 English phrases about the rules, the pitch, the World Cup, training, fans, and the universal grammar of football. Translated into the full
...
- v0.2.0 expansion: +403 new phrases authored across 5 facets
  (rules & the pitch, training & drills, fans & culture, history & the World Cup, life of a player). New-phrase distribution: A0:4, A1:59, A2:140, B1:72, B2:60, C1:48, C2:20.
