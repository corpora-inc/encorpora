# Changelog — The Night phrase pack

`phrase-life-the-night`. 100 English phrases about sleep, insomnia, midnight kitchens, the night shift, dreams, the hour before dawn, and the quiet half of every day. Translated into the full
...
- v0.2.0 expansion: +404 new phrases authored across 5 facets
  (sleep & dreams, insomnia & the wakeful hours, the night shift & late workers, the city at night, dawn & the slow return). New-phrase distribution: A0:4, A1:60, A2:140, B1:72, B2:60, C1:48, C2:20.
