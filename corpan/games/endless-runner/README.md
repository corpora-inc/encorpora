# Endless Runner (Corpan content pack)
...
```
http://localhost:8989/endless-runner/dev.html
```
...
```
http://localhost:8989/endless-runner/manifest.json
```
...
- Pack ID: `endless_runner` (asset packs can’t use hyphens).
