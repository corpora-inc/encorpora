 ...
 * safe-spawn every respawn/teleport/arrival must route through so the player is
 * NEVER dropped inside a collider (the taxi-to-fountain trap: the destination
