 ...
 * a single runnable ESM file, resolving the `@world-plaza/contracts` alias the
...
const pack = resolve(here, "..", "..", "..") // packs/world-plaza
...
await build({
  ...
  alias: {
    "@world-plaza/contracts": resolve(pack, "contracts", "src", "index.ts"),
  },
  logLevel: "info",
})
