...
const scheduleManifestUpdate = () => {
  ...
  updateTimer = setTimeout(async () => {
    try {
      ...
      console.log(`[juice-squeeze2] Updated devRevision: ${manifest.devRevision}`)
    } catch (err) {
      console.error("[juice-squeeze2] Failed to update dev manifest:", err)
    }
  }, 150)
}
...
const watchDist = () => {
  try {
    ...
    console.warn("[juice-squeeze2] Dist watcher unavailable:", err)
  }
}
