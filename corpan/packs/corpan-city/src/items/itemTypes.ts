import { z } from "zod"
import { CosmeticSlot, Rarity } from "@corpan-city/contracts"

/**
 * itemTypes — the first-class **Item** model for Corpan City.
 *
 ...
 *   - This module OWNS the Item schema (kept out of @corpan-city/contracts to
