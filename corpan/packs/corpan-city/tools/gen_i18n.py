#!/usr/bin/env python3
"""Generate Corpan City translations and inject them into an i18n catalog.
...
# ship). Corpan City's manifest only lists `en`, so we default to this set.
DEFAULT_LANGS = [
...
def sys_prompt(lang):
    ...
    return (
        ...
        "Corpan City — a warm, understated paper-craft town where you meet AI "
