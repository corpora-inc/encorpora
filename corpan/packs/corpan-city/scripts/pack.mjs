#!/usr/bin/env node
/**
 * Package corpan-city.zip — Corpan City code pack.
 *
...
async function main() {
  ...
  const zipPath = path.join(packRoot, "corpan-city.zip")
  if (existsSync(zipPath)) {
    await rm(zipPath)
  }

  console.log("Creating corpan-city.zip...")
  execSync("zip -r corpan-city.zip manifest.json dist/", {
    cwd: packRoot,
    stdio: "inherit",
  })

  console.log("\nDone! corpan-city.zip is ready.")
}
