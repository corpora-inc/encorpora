...
EN_FLAT: dict[str, str] = {
    ...
    "onboarding.fork.enjoy.desc": "Read and listen to books and stories in your language.",
    "onboarding.fork.learn.label": "Learn a language",
    "onboarding.fork.learn.desc": "Practice a new language with phrases, books and audio.",
    "onboarding.fork.polyglot.label": "Explore many languages",
    "onboarding.fork.polyglot.desc": "Stack several languages and unlock everything.",
    "onboarding.fork.child.label": "Set it up for a child",
    "onboarding.fork.child.desc": "Gentle, curated reading for younger learners.",
    "onboarding.calibrate.enjoyTitle": "How comfortable are you reading {{lang}}?",
    "onboarding.calibrate.enjoyNative": "It's my language",
    "onboarding.calibrate.enjoyComfortable": "Pretty comfortable",
    "onboarding.calibrate.enjoyImproving": "Still improving",
