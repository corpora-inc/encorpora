    ...
    return (
        ...
        <div className="w-full flex items-center justify-center">
            <button
                ...
                className="inline-flex items-center gap-2 rounded-md border border-gray-300/70 bg-transparent px-4 py-2 text-sm font-medium text-gray-900 shadow-sm transition hover:cursor-pointer hover:bg-white/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 active:scale-[0.99] dark:border-slate-600 dark:bg-transparent dark:text-slate-100 dark:shadow-none dark:hover:bg-white/10 dark:focus-visible:ring-purple-300"
                aria-label={label}
            >
                <Icon size={16} />
                <span>{label}</span>
