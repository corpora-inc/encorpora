...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      // z-[1200] sits above our Dialog primitive (z-[1100]) so a
      // Drawer opened FROM inside a Dialog (e.g. the phrase-pack
      // drawer triggered from SettingsModal) actually appears on top
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        // Match the overlay's z-[1200] so the content sits above our
        // Dialog primitive (z-[1100]) when both are open.
        className={cn(
          "group/drawer-content bg-background fixed z-[1200] flex h-auto flex-col",
