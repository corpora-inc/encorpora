...
\makeatletter
% Level 1: big open circle
% \renewcommand\labelitemi{$\bigcirc$}
% Level 2: normal open circle
% \renewcommand\labelitemii{$\odot$}
...
% % in custom_headings.tex

% % make bullets better especially at level 3
% \usepackage{enumitem}  % easy list tweaking
% \usepackage{pifont}    % for dingbat symbols

% % redefine bullets for itemize levels 1–3:
% \renewcommand\labelitemi{\textbullet}     % ●
% \renewcommand\labelitemii{\textopenbullet} % ◦
% \renewcommand\labelitemiii{\ding{109}}    % ○

% % tighten up spacing and restore default indent
% \setlist[itemize,1]{label=\labelitemi, leftmargin=*, itemsep=0.5\baselineskip}
% \setlist[itemize,2]{label=\labelitemii, leftmargin=*, itemsep=0.3\baselineskip}
% \setlist[itemize,3]{label=\labelitemiii, leftmargin=*, itemsep=0.2\baselineskip}

% % Define Pandoc’s \tightlist if not already defined
...
% \setmainfont{Palatino}     % or any XeLaTeX-compatible font
