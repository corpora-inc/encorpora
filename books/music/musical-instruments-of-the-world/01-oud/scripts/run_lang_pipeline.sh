#!/usr/bin/env bash
# Run a single language end-to-end through the post-EN pipeline for the Oud book.
...
$BIN/ttsctl publish "$PACK" --lang "$LANG" --voice-id sky --tier public --version "$VERSION" > "$LOG/publish.log" 2>&1
...
echo
echo "Listen samples:"
for sid in ch00-002 ch01-005 ch04-008 ch05-009 ch05-022 ch06-014 ch07-008; do
