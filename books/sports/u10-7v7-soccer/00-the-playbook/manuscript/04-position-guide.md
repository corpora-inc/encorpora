...
Pinching in to control the center. The back who reads the play and moves to the center closes the most important channel on the field. Coach it: "Pinch in. The center is your responsibility. The sideline is not going anywhere."

Sending the ball to the sideline. The back who wins the ball and plays it out — to the wing, to the touchline, even out of bounds — keeps the team in control. Coach it: "Send it out. Always out. To the sideline, to the wing, out of bounds if you have to. The sideline is always the right choice in our end."

Staying on their feet. The back who stays balanced and contains the attacker controls the whole situation. Coach it: "Stay on your feet. Slow them down. Guide them to the sideline. Help will come."

Talking constantly. The backs who communicate hold the center together. "I have center." "Go challenge wide." "Switching." "Send it out." The pair that talks is the pair that wins.
...
Ranging between thirds. The complete sweeper defends and pushes forward to link with the point — covering the full job. The best sweepers balance both, anchoring the center and stepping up to connect play. Coach it: the sweeper's home is the center of the field, and they range forward and back from there. In practice, use the freeze technique to check their positioning. "Where are you? Where should you be? Show me."

Finding their voice. The sweeper who talks organizes the entire defense. Coach it: give the sweeper specific phrases. "Push up" when the team needs to advance the line. "Get back" when the 6-0 is needed. "Switch it" when one side is overloaded. "Runner left" or "runner right" when an opponent is making a dangerous run. Start with those and add more as the season progresses.

Distributing through the formation. The sweeper who finds the passing lanes the formation creates moves the ball faster than any individual run. Coach it: reinforce that the sweeper is a distributor. Their job is to make the simple pass that keeps the team moving. The spectacular play will come from the wing strikers and the point. The sweeper makes the play possible by finding them.
...
Sprinting back to launch the counter. The wing who gets all the way back into the 6-0 is the wing who gets the breakaway — that is how this system scores goals. Coach it: the rule is simple. When the team needs to defend, everyone gets goalside. The wing strikers sprint back. And here is the part that makes it exciting: getting back is the setup. The wing who helps win the ball is already in full sprint going forward. That is the most explosive play in the system.
...
Crashing the center for rebounds. The wing who trails every shot and arrives at the goal puts away the rebounds that win games. Coach it: "When there is a shot, get to the goal. Be there for the rebound. Garbage goals win games."
...
Tracking back fully. The point who commits to the 6-0 every time gives the team a complete defensive block and a more explosive counter-attack. Coach it: the rule is simple — when we defend, the point drops all the way back. The counter-attack is more explosive from the 6-0 because the point already has forward momentum when possession changes.
