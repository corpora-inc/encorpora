...
EN_PHONETICS = {
    # Persian / Iranian vocabulary — Chatterbox doesn't know these by sight.
    # Tested by ear; use spaces between syllables, never hyphens (Chatterbox
    # treats "-" as a ~1s pause).
    "tahdig":        "tah deeg",
    "Tahdig":        "Tah deeg",
    "fesenjan":      "fes en jahn",
    "Fesenjan":      "Fes en jahn",
    "ghormeh sabzi": "gor meh sahb zee",
    "Ghormeh sabzi": "Gor meh sahb zee",
    "khoresh":       "khor esh",
    "chelo":         "cheh loh",
    "Chelo":         "Cheh loh",
    "polo":          "poh loh",
    "Polo":          "Poh loh",
    "sabzi polo":    "sahb zee poh loh",
    "kuku sabzi":    "koo koo sahb zee",
    "sangak":        "san gahk",
    "Sangak":        "San gahk",
    "barbari":       "bar bar ee",
    "lavash":        "lah vahsh",
    ...
    "haft-sin":      "haft seen",
    "haft sin":      "haft seen",
    "faloodeh":      "fah loo deh",
    "Faloodeh":      "Fah loo deh",
    "halva":         "hahl vah",
    "gaz":           "gahz",
    "sohan":         "soh hahn",
    "nokhodchi":     "noh khod chee",
    "ash reshteh":   "ahsh resh teh",
    "Ash reshteh":   "Ahsh resh teh",
    "qahveh-khaneh": "kah veh khah neh",
    "qahveh khaneh": "kah veh khah neh",
    "Esfahan":       "es fah hahn",
    "Khorasan":      "khor ah sahn",
    "Persepolis":    "per sep oh lis",
    "esfanaj":       "es fah nahj",
    "pardis":        "par dees",
    "Persica":       "per si ka",
    "shah mat":      "shah maht",
    "Avicenna":      "ah vee sen ah",
    "Ferdowsi":      "fer dow see",
    "Herodotus":     "her rod oh tus",
    "Khuzestan":     "khoo zes tahn",
    "Tabriz":        "tah breez",
    "mahi":          "mah hee",
    "mast o khiar":  "mahst oh khee yar",
    "samanu":        "sah mah noo",
    "senjed":        "sen jed",
    "somagh":        "soh mahg",
    "serkeh":        "ser keh",
...
def apply_phonetics(text: str, phonetics: dict[str, str] | None = None) -> str:
    ...
    # Final pass: dashes are catastrophic in Chatterbox tts.text — em-dashes
    # and en-dashes become ~1s pauses, hyphens in compound words ("hand-picks")
    # become awkward staccato. Replace em/en-dash with ", " (natural pause)
    # and any remaining hyphen with a space (compound becomes two words).
