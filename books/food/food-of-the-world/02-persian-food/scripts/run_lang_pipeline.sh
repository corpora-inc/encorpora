...
PACK=/home/skyl/encorpora/books/food/food-of-the-world/02-persian-food/packs/kym-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=/home/skyl/encorpora/books/food/food-of-the-world/02-persian-food/scripts
VERSION=$($BIN/python -c "import json; print(json.load(open('$PACK/manifest.json'))['version'])")
LOG=/tmp/persian_${LANG_CODE}_${VERSION}
