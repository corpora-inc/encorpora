...
PACK=/home/skyl/encorpora/books/food/food-of-the-world/01-soul-food-of-the-southern-united-states/packs/kym-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=/home/skyl/encorpora/books/food/food-of-the-world/01-soul-food-of-the-southern-united-states/scripts
VERSION=$($BIN/python -c "import json; print(json.load(open('$PACK/manifest.json'))['version'])")
LOG=/tmp/soulfood_${LANG_CODE}_${VERSION}
...
$BIN/ttsctl publish "$PACK" --lang "$LANG_CODE" --voice-id kym --tier public > "$LOG/publish.log" 2>&1
