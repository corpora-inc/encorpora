...
BOOK=/home/skyl/encorpora/books/nature/biomes-of-the-world/02-tropical-savanna
EXPECTED_BOOK_ID=book_biomes_tropical_savanna
PACK=$BOOK/packs/ian-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=$BOOK/scripts
LOG=/tmp/savanna_${LANG}_${VERSION}
mkdir -p "$LOG"
