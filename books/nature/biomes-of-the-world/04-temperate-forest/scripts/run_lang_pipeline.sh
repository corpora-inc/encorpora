...
BOOK=/home/skyl/encorpora/books/nature/biomes-of-the-world/04-temperate-forest
EXPECTED_BOOK_ID=book_biomes_temperate_forest
PACK=$BOOK/packs/ian-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=$BOOK/scripts
LOG=/tmp/temperate_${LANG}_${VERSION}
mkdir -p "$LOG"
