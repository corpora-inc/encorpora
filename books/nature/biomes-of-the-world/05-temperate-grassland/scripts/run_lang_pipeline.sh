...
BOOK=/home/skyl/encorpora/books/nature/biomes-of-the-world/05-temperate-grassland
EXPECTED_BOOK_ID=book_biomes_temperate_grassland
PACK=$BOOK/packs/ian-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=$BOOK/scripts
LOG=/tmp/grassland_${LANG}_${VERSION}
mkdir -p "$LOG"
...
rec = {
    "lang": "$LANG",
    "book": "biomes-temperate-grassland",
