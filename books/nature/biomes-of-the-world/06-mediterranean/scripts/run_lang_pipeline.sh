...
BOOK=/home/skyl/encorpora/books/nature/biomes-of-the-world/06-mediterranean
EXPECTED_BOOK_ID=book_biomes_mediterranean
PACK=$BOOK/packs/ian-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=$BOOK/scripts
LOG=/tmp/mediterranean_${LANG}_${VERSION}
mkdir -p "$LOG"
