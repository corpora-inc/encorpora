...
PACK=/home/skyl/encorpora/books/literature/tolstoy-short-stories/what-men-live-by/packs/kym-chatterbox-v1
BIN=/home/skyl/tts_venv/bin
SCRIPTS=/home/skyl/encorpora/books/literature/tolstoy-short-stories/what-men-live-by/scripts-kym
VERSION=$($BIN/python -c "import json; print(json.load(open('$PACK/manifest.json'))['version'])")
LOG=/tmp/wmlb_kym_${LANG_CODE}_${VERSION}
