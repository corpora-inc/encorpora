...
Usage:
    python3 generate_segments.py [manuscript/what-men-live-by.md]
...
def main():
    ...
    default_manuscript = script_dir.parent / "manuscript" / "what-men-live-by.md"
    ...
    if len(sys.argv) >= 2:
        ...
        print(
            "Usage: python3 generate_segments.py [manuscript/what-men-live-by.md]",
            file=sys.stderr,
        )
        sys.exit(1)
