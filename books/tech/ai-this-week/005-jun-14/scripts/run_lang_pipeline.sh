...
# gates pass; otherwise DROPS the language. Logs to /tmp/ep5_<lang>/.
#
...
LOG="/tmp/ep5_${LANG_CODE}"; mkdir -p "$LOG"
...
# ep5: ko added — Vertex Gemini silently passthrough'd 30 segs ch00-061..097
...
ok=any(n.get('bookId')=='book_ai_this_week_2026_06_14' and n.get('language')=='$LANG_CODE' for n in d['narrations'])
