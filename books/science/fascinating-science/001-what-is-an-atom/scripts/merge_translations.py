...
Rules:
- "text" → seg.text, seg.text_markdown, and seg.tts.text (if tts exists)
- "tts_text" → seg.tts.text (overrides text for tts only, when chemical symbols or numbers need phonetic form)
- "title" → seg.title
- All structural fields (id, part, chapter, paragraph_id, etc.) copied from English source
- pause_after_ms and repetition_penalty preserved from English source
